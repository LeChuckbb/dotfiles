---
name: mode-orchestration
description: Intelligent tool selection and resource optimization. Use when coordinating multiple MCP servers, optimizing performance, managing resource constraints >75%, parallel execution opportunities, complex multi-tool operations, or --orchestrate flag.
category: orchestration
complexity: advanced
mcp-servers: [sequential, context7, magic, playwright, morphllm, serena, tavily]
---
