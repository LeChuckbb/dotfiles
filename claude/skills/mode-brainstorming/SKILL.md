---
name: mode-brainstorming
description: Interactive requirements discovery through Socratic dialogue. Use when user has vague project ideas, mentions brainstorming, needs requirement elicitation, or says "thinking about", "not sure", "maybe", "I want to build something", or provides --brainstorm flag.
