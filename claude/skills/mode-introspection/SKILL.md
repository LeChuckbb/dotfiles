---
name: mode-introspection
description: Meta-cognitive analysis and reasoning transparency. Use when debugging Claude's decisions, analyzing reasoning chains, detecting patterns, error recovery, unexpected results, or user mentions introspection, reflection, self-analysis, --introspect flag.
category: analysis
complexity: advanced
---
