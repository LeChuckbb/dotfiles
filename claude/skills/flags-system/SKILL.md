---
name: flags-system
description: SuperClaude behavioral flags reference for mode activation and tool selection. Use when user provides flags like --brainstorm, --think, --delegate, --uc, --orchestrate, --introspect, --task-manage, MCP flags, or needs flag documentation.
category: utility
complexity: basic
---
