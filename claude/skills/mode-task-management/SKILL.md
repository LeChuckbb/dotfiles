---
name: mode-task-management
description: Hierarchical task organization with persistent memory using Serena. Use when operations have >3 steps, multiple directories (>2) or files (>3), complex dependencies, polish/refine/enhance requests, or user mentions task management, delegation, project tracking, --task-manage, --delegate flags.
